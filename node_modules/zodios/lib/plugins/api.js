    ...
    return function (config) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            if (config.method !== "get") {
                config.headers = __assign(__assign({}, config.headers), { "Content-Type": "application/json", Accept: "application/json" });
            }
            else {
                config.headers = __assign(__assign({}, config.headers), { Accept: "application/json" });
            }
